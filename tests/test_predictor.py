...
def test_mean_is_exact_not_close():
    p = MeanPredictor(k=4)
...
def test_intuition_matures_after_a_step():
    p = MeanPredictor(k=4)
    for _ in range(4):
